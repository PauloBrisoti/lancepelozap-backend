...
ALTER TABLE "purchase_orders" ADD CONSTRAINT "purchase_orders_wallet_id_entrada_fkey" FOREIGN KEY ("wallet_id_entrada") REFERENCES "wallets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "AccountPayable" ADD CONSTRAINT "AccountPayable_purchase_order_id_fkey" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE SET NULL ON UPDATE CASCADE;
