...
export async function adoptPet(req: Request, res: Response) {
  try {
    ...
    console.error("Erro ao registrar adocao:", error);
    return res.status(500).json({ message: "Erro interno" });
  }
}
...
export async function listPetVaccines(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
...
export async function createPetVaccine(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
...
export async function updatePetVaccine(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
    const id = req.params.id as string;
...
export async function deletePetVaccine(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
    const id = req.params.id as string;
...
export async function listPetWeights(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
    const petId = req.query.petId as string;
...
export async function createPetWeight(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
...
export async function deletePetWeight(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
    const id = req.params.id as string;
...
export async function listServiceCatalog(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
...
export async function createCatalogItem(req: Request, res: Response) {
  try {
    ...
    console.error("Erro ao criar item catalogo:", error);
    return res.status(500).json({ message: "Erro interno" });
  }
}
...
export async function updateCatalogItem(req: Request, res: Response) {
  try {
    ...
    console.error("Erro ao atualizar item catalogo:", error);
    return res.status(500).json({ message: "Erro interno" });
  }
}
...
export async function deleteCatalogItem(req: Request, res: Response) {
  try {
    ...
    console.error("Erro ao excluir item catalogo:", error);
    return res.status(500).json({ message: "Erro interno" });
  }
}
...
export async function createServiceOrder(req: Request, res: Response) {
  try {
    ...
    console.error("Erro ao criar ordem servico:", error);
    return res.status(500).json({ message: "Erro interno" });
  }
}
  ...
  try {
    ...
    if (status === "CONCLUIDO") {
      ...
      if (order.recorrente && order.items.length > 0) {
        ...
        enviarLembreteRecorrencia(storeId, order.id, proximaEntrada, nomesServicos, Number(order.valorFinal)).catch(() => {});
      }
...
export async function remindServiceOrder(req: Request, res: Response) {
  try {
    const storeId = req.user?.storeId as string;
    if (!storeId) return res.status(401).json({ message: "Loja nao identificada" });
    const id = req.params.id as string;
    ...
    console.error("Erro ao lembrar ordem:", error);
    return res.status(500).json({ message: "Erro interno" });
  }
}
